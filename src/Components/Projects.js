        ...
        return(
            <div className ="projects" id = "projects">
                ...
                <div className ="prjs">
                    ...
                    <a href ="https://kevinkh14.github.io/GenaDROPs-Skills-Test-/#/Create" target="_blank"><img className = "prj-img" src ="/images/gena3.PNG"/></a>
                    <a href ="https://kevinkh14.github.io/GenaDROPs-Skills-Test-/#/Create" target="_blank"><img className = "prj-img" src ="/images/genadeop.PNG"/></a>
